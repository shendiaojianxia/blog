...
public class VendingMachine
{
    ...
    public void testMachine(){
        assertEquals("Item dispensed.", dispenseItem(20, "candy"));
        assertEquals("Item dispensed and change of "+ 10 + " returned", dispenseItem(35, "coke"));
        assertEquals("Item not dispensed, missing " + 35 + " cents. Cannot purchase item.", dispenseItem(10, "coffee"));
    }
